...
common_conf_module = __import__('conf.configs.common', globals(), locals(), 'django-poll-site')
...
# Retrieve what this system calls its hostname
...
# If we're running test or test_coverage, run a streamlined settings file for efficiency
else:
    TESTING = True

    test_conf_module = __import__('conf.configs.test', globals(), locals(), 'django-poll-site')
